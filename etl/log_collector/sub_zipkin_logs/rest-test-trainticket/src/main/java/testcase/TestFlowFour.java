...
public class TestFlowFour {
    ...
    public static void serviceLogin(WebDriver driver, String username, String password, String verificationCode){
        ...
        driver.findElement(By.id("flow_advance_reserve_login_verification_code")).clear();
        driver.findElement(By.id("flow_advance_reserve_login_verification_code")).sendKeys(verificationCode);
...
//        baseUrl = "http://10.141.211.161:31380";
    ...
    public void login()throws Exception {
        ...
        //get login status
        String statusLogin = driver.findElement(By.id("flow_advance_reserve_login_msg")).getText();
    ...
    public void testAdvancedSearching() throws Exception{
        ...
        js.executeScript("document.getElementById('flow_advance_reserve_startingPlace').value='Nan Jing'");
        js.executeScript("document.getElementById('flow_advance_reserve_terminalPlace').value='Shang Hai'");
        ...
        js.executeScript("document.getElementById('flow_advance_reserve_booking_date').value='" + date + "'");

        // simulate dropdown list
        Select searchType = new Select(driver.findElement(By.id("flow_advance_reserve_select_searchType")));
        searchType.selectByValue("Quickest"); // 3rd: quickest

        driver.findElement(By.id("flow_advance_reserve_booking_button")).click();

        List<WebElement> ticketsList = driver.findElements(By.xpath("//table[@id='flow_advance_reserve_booking_list_table']/tbody/tr"));
        //Confirm ticket selection
        if (null == ticketsList || ticketsList.size() == 0) {
            driver.findElement(By.id("flow_advance_reserve_booking_button")).click();
            ticketsList = driver.findElements(By.xpath("//table[@id='flow_advance_reserve_booking_list_table']/tbody/tr"));
        }
        else {
    ...
    public void testSelectContacts() throws Exception {
        ...
        List<WebElement> contactsList = driver.findElements(By.xpath("//table[@id='flow_advance_reserve_contacts_booking_list_table']/tbody/tr"));

        //Confirm ticket selection
        if (null == contactsList || contactsList.size() == 0) {
            driver.findElement(By.id("flow_advance_reserve_booking_contacts_button")).click();
            Thread.sleep(1000);
            contactsList = driver.findElements(By.xpath("//table[@id='flow_advance_reserve_contacts_booking_list_table']/tbody/tr"));
        }
        ...
        driver.findElement(By.id("flow_advance_reserve_ticket_select_contacts_confirm_btn")).click();
    ...
    public void testConfirmTicketInfo() throws Exception {
        ...
        String itemFrom = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_from")).getText();
        String itemTo = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_to")).getText();
        String itemTripId = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_tripId")).getText();
        String itemPrice = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_price")).getText();
        String itemDate = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_travel_date")).getText();
        String itemName = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_contactsName")).getText();
        String itemSeatType = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_seatType_String")).getText();
        String itemDocumentType = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_documentType")).getText();
        String itemDocumentNum = driver.findElement(By.id("flow_advance_reserve_ticket_confirm_documentNumber")).getText();
        ...
        if(!bStatusConfirm){
            driver.findElement(By.id("flow_advance_reserve_ticket_confirm_cancel_btn")).click();
            System.out.println("Confirming Ticket Canceled!");
        }

        Assert.assertEquals(bStatusConfirm,true);

        driver.findElement(By.id("flow_advance_reserve_ticket_confirm_confirm_btn")).click();
        Thread.sleep(1000);
    ...
    public void testPayTicket() throws Exception {
        ...
        String itemOrderId = driver.findElement(By.id("flow_advance_reserve_pay_orderId")).getAttribute("value");
        String itemPrice = driver.findElement(By.id("flow_advance_reserve_pay_price")).getAttribute("value");
        String itemTripId = driver.findElement(By.id("flow_advance_reserve_pay_tripId")).getAttribute("value");
        ...
        driver.findElement(By.id("flow_advance_reserve_pay_btn")).click();
        Thread.sleep(1000);

        String itemCollectOrderId = driver.findElement(By.id("flow_advance_reserve_collect_order_id")).getAttribute("value");
    ...
    public void testTicketCollect() throws Exception {
        ...
        driver.findElement(By.id("flow_advance_reserve_collect_button")).click();
        Thread.sleep(1000);

        // need to check
        String statusCollectOrderId = driver.findElement(By.id("flow_advance_reserve_collect_order_status")).getText();
    ...
    public void testEnterStation() throws Exception{
        ...
        String itemEnterOrderId = driver.findElement(By.id("advance_reserve_execute_order_id")).getAttribute("value");
        ...
        String statusEnterStation = driver.findElement(By.id("flow_advance_reserve_order_status")).getText();
