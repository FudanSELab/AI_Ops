...
public class OrderOtherServiceImpl implements OrderOtherService {
    ...
    @Override
    public LeftTicketInfo getSoldTickets_Modified(SeatRequest seatRequest, HttpHeaders headers) {
        ArrayList<Order> list = orderOtherRepository.findByTravelDateAndTrainNumber(seatRequest.getTravelDate(), seatRequest.getTrainNumber());
    ...
    @Override
    public Order findOrderById_Modified(UUID id, HttpHeaders headers) {
        return orderOtherRepository.findById(id);
    }

    @Override
    public CreateOrderResult create_Modified(Order order, HttpHeaders headers) {
    ...
    @Override
    public void initOrder_Modified(Order order, HttpHeaders headers) {
    ...
    @Override
    public OrderAlterResult alterOrder_Modified(OrderAlterInfo oai, HttpHeaders headers) {
    ...
    @Override
    public ArrayList<Order> queryOrders_Modified(QueryInfo qi, String accountId, HttpHeaders headers) {
        ...
        if (qi.isEnableStateQuery() || qi.isEnableBoughtDateQuery() || qi.isEnableTravelDateQuery()) {
            ...
            for (Order tempOrder : list) {
                ...
                if (qi.isEnableTravelDateQuery()) {
                    if (tempOrder.getTravelDate().before(qi.getTravelDateEnd()) && tempOrder.getTravelDate().after(qi.getBoughtDateStart())) {
                ...
                if (qi.isEnableBoughtDateQuery()) {
                    if (tempOrder.getBoughtDate().before(qi.getBoughtDateEnd()) && tempOrder.getBoughtDate().after(qi.getBoughtDateStart())) {
    ...
    @Override
    public ArrayList<Order> queryOrdersForRefresh_Modified(QueryInfo qi, String accountId, HttpHeaders headers) {
    ...
    public ArrayList<String> queryForStationId_Modified(ArrayList<String> ids, HttpHeaders headers) {
        QueryByIdBatch batch = new QueryByIdBatch(ids);
        HttpEntity requestEntity = new HttpEntity(batch, headers);
        ResponseEntity<QueryByIdBatchResult> re = restTemplate.exchange("http://ts-station-service:12345/station/queryByIdBatch", HttpMethod.POST, requestEntity, QueryByIdBatchResult.class);
        QueryByIdBatchResult names = re.getBody();
        return names.getStationNameList();
    }

    @Override
    public ChangeOrderResult saveChanges_Modified(Order order, HttpHeaders headers) {
    ...
    @Override
    public CancelOrderResult cancelOrder_Modified(CancelOrderInfo coi, HttpHeaders headers) {
    ...
    @Override
    public CalculateSoldTicketResult queryAlreadySoldOrders_Modified(CalculateSoldTicketInfo csti, HttpHeaders headers) {
    ...
    @Override
    public QueryOrderResult getAllOrders_Modified(HttpHeaders headers) {
    ...
    @Override
    public ModifyOrderStatusResult modifyOrder_Modified(ModifyOrderStatusInfo info, HttpHeaders headers) {
    ...
    @Override
    public GetOrderPriceResult getOrderPrice_Modified(GetOrderPrice info, HttpHeaders headers) {
        Order order = orderOtherRepository.findById(UUID.fromString(info.getOrderId()));
    ...
    @Override
    public PayOrderResult payOrder_Modified(PayOrderInfo info, HttpHeaders headers) {
        Order order = orderOtherRepository.findById(UUID.fromString(info.getOrderId()));
    ...
    @Override
    public GetOrderResult getOrderById_Modified(GetOrderByIdInfo info, HttpHeaders headers) {
        Order order = orderOtherRepository.findById(UUID.fromString(info.getOrderId()));
    ...
    @Override
    public GetOrderInfoForSecurityResult checkSecurityAboutOrder_Modified(GetOrderInfoForSecurity info, HttpHeaders headers) {
    ...
    @Override
    public DeleteOrderResult deleteOrder_Modified(DeleteOrderInfo info, HttpHeaders headers) {
    ...
    @Override
    public AddOrderResult addNewOrder_Modified(Order order, HttpHeaders headers) {
    ...
    @Override
    public UpdateOrderResult updateOrder_Modified(Order order, HttpHeaders headers) {
        Order oldOrder = findOrderById(order.getId(), headers);
